...
void GDT_init() {
    ...
    set_code_segment_descriptor_64(&GDT[9], true, true, false, 3, true, true, true, false, true);
    set_data_segment_descriptor(&GDT[10], 0, 0xffffffff, true, true, false, 3, true, true, true, true);
}
